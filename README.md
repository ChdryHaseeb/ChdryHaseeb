...
- 💻 **Tech Stack:** C++ (Core), Python (Learning), Qt Framework.
- 🕹️ **Interests:** Game Development logic, 2D array optimization, and AI systems.

### 🛠️ Technical Skills
- **Languages:** C++ (Strong), Python (Intermediate).
- **Tools:** GitHub, Cisco Packet Tracer, Flask, SQLite.
- **Academic Focus:** Object-Oriented Programming, Discrete Structures, Digital Logic Design.
